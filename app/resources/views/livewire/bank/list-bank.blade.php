...
<div class="p-6">
    ...
    <div class="flex justify-end w-full">
        <div class="flex flex-col items-center gap-2" wire:ignore>
            <div
                class="flex space-x-2 w-full text-center rounded-lg border border-gray-300 dark:border-neutral-700 bg-white dark:bg-neutral-900 p-2">
            ...
            <div class="w-full overflow-x-auto rounded-lg border dark:border-neutral-700">
                <table class="min-w-max w-full table-auto divide-y divide-gray-200 dark:divide-neutral-700">
                    <thead class="bg-gray-50 dark:bg-neutral-800">
                        <tr>
                            <th
                                class="px-4 py-2 text-xs font-medium text-gray-500 dark:text-neutral-400 uppercase tracking-wider text-center">
                                No
                            </th>
                            <th
                                class="px-4 py-2 text-xs font-medium text-gray-500 dark:text-neutral-400 uppercase tracking-wider text-center">
                    ...
                    <tbody class="bg-white dark:bg-neutral-900 divide-y divide-gray-200 dark:divide-neutral-700">
                        ...
                        <tr class="hover:bg-gray-50 text-center dark:hover:bg-neutral-800 transition-colors">
                            ...
                            <td class="px-4 py-4 text-center text-sm font-medium text-gray-800 dark:text-neutral-200">
                                {{strtoupper($b->customer->name)}}
                            </td>
                            <td class="px-4 py-4 text-center text-sm font-medium text-gray-800 dark:text-neutral-200">
                                <div class="flex justify-center space-x-3 font-bold">
                                    <a wire:navigate href="{{ route('viewBank', ['id' => $b->id]) }}"
                                        class="text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300">View</a>
                                    <a wire:navigate href="{{ route('EditJob', ['id' => $b->id]) }}"
                                        class="text-yellow-600 hover:text-yellow-800 dark:text-yellow-400 dark:hover:text-yellow-300">Update</a>
