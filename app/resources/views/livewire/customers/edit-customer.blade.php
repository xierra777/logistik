<form wire:submit.prevent="updateCustomer" class="p-6 text-dark-900 dark:text-gray-100">
    <div class="space-y-12">
        <div class="border-b border-gray-900/10 pb-12">
            <h2 class="text-base/7 font-semibold text-gray-900">Edit Data Organisasi</h2>
            <br>
            ...
            <div class="relative w-full mb-4 bg">
                ...
                <div wire:ignore>
                    <select id="countrySelect" class="w-full">
            ...
            <div wire:ignore class="relative w-full mb-4 bg">
                ...
                <select wire:model="roles" id="mySelect2" class="w-full" multiple>
...
<script>
    document.addEventListener("livewire:load", function() {
        Livewire.on('syncCountry', (countryValue) => {
...
<script>
    $(document).ready(function() {
        ...
        function loadCountries(selectedCountry = null) {
            $.ajax({
                ...
                success: function(data) {
                    ...
                    // Set value dari Livewire ke Select2
                    if (selectedCountry) {
        ...
        // Panggil loadCountries dengan nilai default dari Livewire
        Livewire.hook('message.processed', (message, component) => {
            loadCountries($wire.country); // Set nilai dari Livewire ke Select2 setelah reload
        });

        loadCountries($wire.country);
    });
