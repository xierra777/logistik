                ...
                <table class="min-w-full divide-y divide-gray-200 whitespace-nowrap dark:divide-neutral-700">
                    <thead class="bg-gray-50 dark:bg-neutral-800 sticky top-0 z-10">
                        <tr>
                            ...
                            <th class="px-6 py-3 text-xs font-bold text-gray-500 uppercase dark:text-neutral-400 text-end">Action</th>
                        </tr>
                    </thead>
                    <tbody class="bg-white dark:bg-neutral-900 divide-y divide-gray-300 dark:divide-neutral-800">
                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-neutral-800">
                            ...
                            <td class="px-6 py-4 text-sm text-end font-medium space-x-3">
                                <a href="/view-customers/{{ $customer->id }}" class="text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300 font-bold">View</a>
                                <a href="/edit-customers/{{ $customer->id }}" class="text-yellow-600 hover:text-yellow-800 dark:text-yellow-400 dark:hover:text-yellow-300 font-bold">Update</a>
                                <button type="button" @click="$dispatch('confirm-delete', { get_id: {{ $customer->id }} })" class="text-red-600 hover:text-red-800 dark:text-red-400 dark:hover:text-red-300 font-bold">Delete</button>
                            </td>
                        </tr>
                        @empty
                        <tr>
                            <td colspan="5" class="py-12 text-center">
                                <div class="flex flex-col items-center justify-center max-w-md mx-auto">
                                    ...
                                    <p class="text-sm text-gray-500 dark:text-neutral-500 text-center">Start by adding customers or importing data.</p>
                                </div>
                            </td>
                        </tr>
                        @endforelse
