    ...
    init() {
        ...
        this.$watch('step', () => {
            ...
            <div x-show="step === 1" x-transition x-cloak>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
                    ...
                    <label class="flex w-full items-center space-x-2 cursor-pointer border p-2 rounded border-gray-400 hover:bg-gray-100 rounded-lg">
                        <input type="radio" wire:model="type_job" value="{{ $key }}"
            ...
            <div x-show="step === 2" x-transition x-cloak>
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
                        ...
                        <div class="mb-4" wire:ignore>
                            ...
                            <select name="deliveryAgent" id="deliveryAgent_export" :key="'deliveryAgent_export' . $job->type_job" wire:model="deliveryAgent" class="block w-full rounded-md border-gray-300 shadow-sm focus:ring focus:ring-blue-200">
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
                        ...
                        <div class="mb-4" wire:ignore>
                            ...
                            <select name="originAgent" id="originAgent_import" :key="'originAgent_import' . $job->type_job" wire:model="originAgent" class="block w-full rounded-md border-gray-300 shadow-sm focus:ring focus:ring-blue-200">
                                <option value="">Select agent</option>
                ...
                <div class="mb-4" wire:ignore>
                    <label for="originAgent">Origin Agent</label>
                    <select name="originAgent" id="originAgent_import" wire:model="originAgent" class="block w-full rounded-md border-gray-300 shadow-sm focus:ring focus:ring-blue-200">
                        <option value="">Select agent</option>
                ...
                <div class="mb-4" wire:ignore>
                    <label for="deliveryAgent">Delivery Agent</label>
                    <select name="deliveryAgent" id="deliveryAgent_export" wire:model="deliveryAgent" class="block w-full rounded-md border-gray-300 shadow-sm focus:ring focus:ring-blue-200">
                        <option value="">Select agent</option>
                        @foreach($dagentsJob as $da)
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
                        ...
                        <div class="mb-4" wire:ignore>
                            <label for="deliveryAgent">Delivery Agent</label>
                            <select name="deliveryAgent" id="deliveryAgent" wire:key="deliveryAgent" wire:model="deliveryAgent" class="block w-full rounded-md border-gray-300 shadow-sm focus:ring focus:ring-blue-200">
                                <option value="">Select agent</option>
                                @foreach($dagentsJob as $da)
                                @if(in_array('agent', $cr->roles))
                                <option value="{{ $da->id }}">{{ $da->name }}</option>
