    ...
    <div>
        ...
        <div class="grid grid-cols-3">
            ...
            <div class="flex flex-col">
                ...
                <span class="bg-white px-4 py-2">{{ $shipment->shipper->name ?? 'N/A' }}</span>
            </div>
            <div class="flex flex-col">
                <span class="font-bold bg-gray-200 px-4 py-2">Consignee</span>
                <span class="bg-white px-4 py-2">{{ $shipment->consignee->name ?? 'N/A' }}</span>
            </div>
            <div class="flex flex-col">
                <span class="font-bold bg-gray-200 px-4 py-2">Notify</span>
                <span class="bg-white px-4 py-2">{{ $shipment->notify->name ?? 'N/A' }}</span>
            </div>
            <!-- Baris 2 -->
            <div class="flex flex-col">
